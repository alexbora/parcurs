 ...
 * @file        : cpuid3
 * @created     : Monday Sep 26, 2022 17:14:07 UTC
 */
...
char *Assoc[] = {
    "L2 off",   "Direct mapped", "2-way",    "reserved", "4-way",    "reserved",
    "8-way",    "reserved",      "16-way",   "reserved", "reserved", "reserved",
    "reserved", "reserved",      "reserved", "full",
};
...
void doamd(int maxi) {
  ...
  if (maxei >= 0x80000005) {
    ...
    printf("   size %ld KB associativity %lx-way lines per tag %ld line size "
           "%ld\n",
