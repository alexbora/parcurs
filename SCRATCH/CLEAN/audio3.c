 ...
 * @file        : audio3
 * @created     : Joi Mai 18, 2023 11:23:48 EEST
 */

#include <SDL2/SDL.h>
#include <stdlib.h>

#define MUS_PATH "/Users/alex/dev/wx/miniaudio/test.mp3",
...
my_audio_callback(void* userdata, Uint8* stream, int len)
{
  ...
  // SDL_memcpy (stream, audio_pos, len); // simply copy from one buffer into
  // the other
